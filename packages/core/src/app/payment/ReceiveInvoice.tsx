...
const ALLOWED_IPS = ['82.180.32.121']; // Sostituisci con gli IP consentiti


export default function ReceiveInvoice({
  isInvoiceValidated,
  setIsInvoiceValidated,
  isInvoiceChecked,
  setIsInvoiceChecked,
  checkoutService,
}: {
  isInvoiceValidated: boolean;
  setIsInvoiceValidated: (checked: boolean) => void;
  isInvoiceChecked: boolean;
  setIsInvoiceChecked: (checked: boolean) => void;
            ...
            {isInvoiceChecked && (
              <>
                <p className="optimizedCheckout-contentSecondary">
                  Se hai bisogno di un indirizzo di fatturazione diverso da quello di spedizione,
                  compila l'indirizzo di fatturazione nella sezione di pagamento.
                </p>
                ...
                <div className="form-actions" style={{ marginBottom: '15px' }}>
                  ...
                  >
                    {isLoading ? (
                      ...
                      >
                        {' '}
                        {/* Usa le classi esistenti per il mascherino */}
